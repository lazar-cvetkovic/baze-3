...
namespace Baze3.Forms
{
    ...
    {
        private readonly IMestoService _srv;
        ...
        {
            _srv = srv; _opstina = opstina; Text = "Novo mesto"; Width = 420; Height = 180;
            ...
            _save.Click += (s, e) => {
                try { _srv.Create(new Mesto { RbMesta = (int)_rb.Value, NazivMesta = _naziv.Text, RbOpstine = _opstina.RbOpstine }); }
