...
namespace Baze3.Forms
{
    ...
    {
        private readonly IOpstinaService _srv;
        ...
        {
            _srv = srv; Text = "Nova opština"; Width = 420; Height = 180;
            ...
            _save.Click += (s, e) => {
                try { _srv.Create(new Opstina { RbOpstine = (int)_rb.Value, NazivOpstine = _naziv.Text }); }
